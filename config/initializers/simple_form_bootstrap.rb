...
SimpleForm.setup do |config|
  ...
  # FIXME: почему обертка у ИНЛАЙН формы DIV?
  ...
  config.wrappers :custom_collection_inline, item_wrapper_class: 'custom-control custom-control-inline', item_label_class: 'custom-control-label', tag: 'fieldset',
  ...
  config.wrappers :custom_image_preview, tag: 'div', class: 'form-group', error_class: 'form-group-invalid', valid_class: 'for
m-group-valid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    ...
    b.wrapper :custom_wrapper, tag: 'div' do |ba|
      ba.use :image, class: 'img-fluid rounded shadow-sm mb-3'
      ba.wrapper :custom_file_wrapper, tag: 'div', class: 'custom-file' do |bb|
        bb.use :input, class: 'custom-file-input', error_class: 'is-invalid', valid_class: 'is-valid'
        bb.use :label, class: 'custom-file-label'
        bb.use :full_error, wrap_with: { tag: 'div', class: 'invalid-feedback' }
      end
    end
    b.use :hint, wrap_with: { tag: 'small', class: 'form-text text-muted' }
  ...
  config.wrappers :lg_form, tag: 'div', class: 'form-group', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
